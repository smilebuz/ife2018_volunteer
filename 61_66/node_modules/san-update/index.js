(function (global, factory) {
  ...
  (factory((global.sanUpdate = global.sanUpdate || {})));
 ...
 * @return {Object} 更新后的新对象
 */
var push = function push(source, path, value) {
 ...
 * @return {Object} 更新后的新对象
 */
var unshift = function unshift(source, path, value) {
 ...
 * @return {Object} 更新后的新对象
 */
var pop = function pop(source, path, assert) {
 ...
 * @return {Object} 更新后的新对象
 */
var shift = function shift(source, path, assert) {
 ...
 * @return {Object} 更新后的新对象
 */
var removeAt = function removeAt(source, path, index) {
 ...
 * @return {Object} 更新后的新对象
 */
var remove = function remove(source, path, value) {
 ...
 * @return {Object} 更新后的新对象
 */
var splice = function splice(source, path, start, deleteCount) {
 ...
 * @return {Object} 更新后的新对象
 */
var map = function map(source, path, callback) {
 ...
 * @return {Object} 更新后的新对象
 */
var filter = function filter(source, path, callback) {
 ...
 * @return {Object} 更新后的新对象
 */
var reduce = function reduce(source, path) {
 ...
 * @return {Object} 更新后的新对象
 */
var merge = function merge(source, path, value) {
 ...
 * @return {Object} 更新后的新对象
 */
var apply = function apply(source, path, factory) {
 ...
 * @return {Object} 更新后的新对象
 */
var omit = function omit(source, path) {
 ...
 * @return {Object} 更新后的新对象
 */
var composeBefore = function composeBefore(source, path, before) {
 ...
 * @return {Object} 更新后的新对象
 */
var composeAfter = function composeAfter(source, path, after) {
 ...
 * @return {Object} 更新后的新对象
 */
var applyWith = function applyWith(source, path, selectors, factory) {
  if (Array.isArray(selectors)) {
    var _ret = function () {
      ...
      return {
        v: apply(source, path, boundFactory)
      };
    }();
...
var createUpdater = function createUpdater(_value, commands) {
    return availableCommandNames.reduce(function (updater, shortcut) {
        updater[shortcut] = function (path) {
            for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                args[_key - 1] = arguments[_key];
            }

            var additionCommand = defineProperty({}, '$' + shortcut, args.length === 1 ? args[0] : args);
            var newCommands = merge(commands, path, additionCommand);
            return createUpdater(_value, newCommands);
        };
        return updater;
    }, {
        value: function value() {
            return update(_value, commands);
        },
        withDiff: function withDiff$$1() {
            return withDiff(_value, commands);
        }
    });
};
...
var chain = (function (source) {
    return createUpdater(source, EMPTY_COMMANDS);
});
...
var createMacro = function createMacro(commands) {
    return availableCommandNames.reduce(function (macro, shortcut) {
        macro[shortcut] = function (path) {
            for (var _len = arguments.length, args = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
                args[_key - 1] = arguments[_key];
            }
        ...
        build: function build() {
            ...
            result.withDiff = function (value) {
                return withDiff(value, commands);
            };
            return result;
        },
        buildWithDiff: function buildWithDiff() {
...
exports.chain = chain;
exports.immutable = chain;
exports.macro = macro;
exports.builder = macro;
exports.updateBuilder = macro;
...
exports.composeAfter = composeAfter;
